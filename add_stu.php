...
if(isset($btn))
{
$mq=mysqli_query($connect,"select max(id) from cargo_details");
$mr=mysqli_fetch_array($mq);
$id=$mr['max(id)']+1;

$ins=mysqli_query($connect,"insert into cargo_details(id,truckno,user,idno,ldweight,petrol,place,amount,fweight,rdate,drname,status) values($id,'$truckno','$user','$idno','$ldweight','$petrol','$place','$amount','','$rdate','','0')");
	
if($ins)
	{
?>
<script language="javascript">
window.location.href="view_stu.php?truckno=<?php echo $truckno; ?>";
</script>
<?php
	}
	else
	{
	$msg="Idno No. Already Exist!";
	}
}
	
if($act=="del")
{
mysqli_query($connect,"delete from sbus_reg where id=$did");
?>
<script language="javascript">
window.location.href="add_stu.php";
</script>
<?php
}
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="nav-link scrollto" href="home.php">Home</a></li>
          ...
          <li><a class="nav-link scrollto active" href="view_stu.php">Cargo</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <div class="sidebar">
              ...
              <h3 class="sidebar-title">Add Cargo Details</h3>
              <div class="reply-form">
                <form name="form1" method="post" action="">
                  <div class="row">
                      ...
                      <select name="truckno" class="form-control">
	                            <?php
	                            $cq=mysqli_query($connect,"select * from  cargo_truck order by truckno desc limit 1");
                    ...
                    <div class="col-md-6 form-group">
                         <select name="user" class="form-control">
	                          <?php
	                             $cq=mysqli_query($connect,"select * from  cargo_booking order by id desc limit 1");
	                             while($cr=mysqli_fetch_array($cq))
	                               {
	                           ?>
	                           <option><?php echo $cr['user']; ?></option>
                                  <?php
	                              }
	                                ?>
	                        </select>                   
				...
				<div class="row">
					<div class="col-md-6 form-group">
                      <input name="idno" type="text" class="form-control" value="<?php echo $idno;?>" readonly required>
                    </div>
                    <div class="col-md-6 form-group">
                      <input name="ldweight" type="text" class="form-control" placeholder="Cargo Weight" required>
                    </div>
                 </div>
				  <br>
				<div class="row">
					<div class="col-md-6 form-group">
                      <input name="petrol" type="text" class="form-control" placeholder="Petrol" required>
                    </div>
                    <div class="col-md-6 form-group">
          ...
          <div class="row">
					<div class="col-md-6 form-group">
                      <input name="amount" type="text"  class="form-control" placeholder="Charge Amount" required>
                    </div>
