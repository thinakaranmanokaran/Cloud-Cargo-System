...
$mq=mysqli_query($connect,"select max(id) from  cargo_driver");
...
{
$pass="1234";
$ins=mysqli_query($connect,"insert into  cargo_driver(id,uname,name,mobile,address,pass) values($id,'$uname','$name','$mobile','$address','$pass')");
	if($ins)
	{
?>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="nav-link scrollto" href="home.php">Home</a></li>
		  <li><a class="nav-link scrollto active" href="view_driver.php">Driver</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <div class="sidebar">
              ...
              <h3 class="sidebar-title">Add Driver</h3>
              <div class="reply-form">
                <form name="form1" method="post" action="">
                  <div class="row">
				  	<div class="col-md-6 form-group">
                      <input name="uname" type="text" class="form-control" placeholder="Driver ID" value="<?php echo $drid; ?>" required>
                    </div>
                    <div class="col-md-6 form-group">
                      <input name="name" type="text" class="form-control" placeholder="Driver Name" required>
                    </div>
