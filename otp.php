...
if(isset($b1))
{
$q1=mysqli_query($connect,"select * from customer where otp='$otp' limit 0,1");
$n1=mysqli_num_rows($q1);
	...
	<script language="javascript">
		window.location.href="check.php?truckno=<?php echo $truckno;?>";
		</script>
		<?php
	}
	else
...
<body>
  ...
  <main id="main">
   ...
   <section id="services" class="services">
	...
	<div class="col-md-3">
	<input type="submit" name="b1" value="submit" class="btn">
	</div>
	</div>
