...
extract($_REQUEST);
	if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from customer where username='$uname' && password='$pass' ");
			$n1=mysqli_num_rows($q1);
				if($n1==1)
				{
				$_SESSION['username']=$uname;
				header("location:cusreq.php");
				}
				else
				{
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="customer.php">Customer</a></li>
            ...
            <div class="sidebar">
              ...
              <div class="reply-form">
                <form name="form1" method="post" action="">
                  ...
                  <a class="btn btn-primary" href="cusreg.php">Register</a>
