...
$bus="bus_close.jpg";
	...
	{
	$loc=$lat.",".$lon;
		$q1=mysqli_query($connect,"select * from sbus_staff where regno='$regno'");
		...
		$email=$r1['email'];
			...
			$q2=mysqli_query($connect,"select * from sbus_det where busno='$busno' && regno='$regno' order by id desc");
			$n2=mysqli_num_rows($q2);
				...
				$mq=mysqli_query($connect,"select max(id) from sbus_det");
				$mr=mysqli_fetch_array($mq);
				$id=$mr['max(id)']+1;
		
				mysqli_query($connect,"insert into sbus_det(id,details,lat,lon,busno,regno,stud_st,rdate,rtime) values($id,'$mess','$lat','$lon','$busno','$regno','$st','$rdate','$rtime')");
			
		$message="Student: $name ($regno), has $mess, Location: $loc";	
		...
		mysqli_query($connect,"insert into sbus_det(id,details,lat,lon,busno,regno,stud_st,rdate,rtime,utype) values($id,'$mess','$lat','$lon','$busno','','$st','$rdate','$rtime','Staff')");
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
		  ...
		  <li><a class="nav-link scrollto active" href="login_staff.php">Staff</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="assets/img/bbus.jpg" alt="" class="img-fluid">
              </div>
