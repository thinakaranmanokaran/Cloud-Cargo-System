...
if($act=="del")
{
mysqli_query($connect,"delete from cargo_details where id=$did");
?>
   ...
   <section id="services" class="services">
	...
	<input type="submit" name="b1" value="Go" class="btn">
        ...
        <p>Customer: <?php echo $r1['user']; ?></p>
			  ...
			  <p align="right"><a href="view_stu.php?act=del&did=<?php echo $r1['id']; ?>&truckno=<?php echo $truckno; ?>">Delete</a></p>
            </div>
          </div>
		 <?php
		 	}
