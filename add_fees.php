...
if(isset($btn))
{
$mq=mysqli_query($connect,"select max(id) from sbus_fees");
$mr=mysqli_fetch_array($mq);
$id=$mr['max(id)']+1;

$ins=mysqli_query($connect,"insert into sbus_fees(id,semester,fees,status,rdate) values($id,'$semester','$fees','0','$rdate')");
echo "insert into sbus_fees(id,semester,fees,status,rdate) values($id,'$semester','$fees','0','$rdate'";
	if($ins)
	{
?>
...
<body>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <div class="sidebar">
              ...
              <h3 class="sidebar-title">Add Bus Fees</h3>
    ...
    <option>Semester 6</option>
                    ...
                    <div class="col-md-6 form-group">
                      <input name="fees" type="text" class="form-control" placeholder="Fees" required>
                    </div>
