...
if(isset($btn))
{
$mq=mysqli_query($connect,"select max(id) from cargo_truck");
$mr=mysqli_fetch_array($mq);
$id=$mr['max(id)']+1;

$ins=mysqli_query($connect,"insert into cargo_truck(id,truckno,driver) values($id,'$truckno','$driver')");
	if($ins)
	{
mysqli_query($connect,"update  cargo_driver set truckno='$truckno' where uname='$driver'");

$mq2=mysqli_query($connect,"select max(id) from cargotruck_route");
...
$lat="12.2380245";
$lon="79.0225636";
mysqli_query($connect,"insert into cargotruck_route(id,truckno,route,lat,lon) values($id2,'$truckno','Tiruvannamalai','$lat','$lon')");
        ...
        <div class="row">
          ...
          <div class="col-lg-4 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="assets/img/lorry1.jpg" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-8">
            ...
            <div class="sidebar">
              ...
              <h3 class="sidebar-title">Add Truck</h3>
              <div class="reply-form">
                <form name="form1" method="post" action="">
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input name="truckno" type="text" class="form-control" placeholder="Truck No." required>
                    </div>
					<div class="col-md-6 form-group">
                      <select name="driver" class="form-control" required>
					  <option value="">-Driver-</option>
					  <?php
					  $cq1=mysqli_query($connect,"select * from cargo_driver where truckno=''");
