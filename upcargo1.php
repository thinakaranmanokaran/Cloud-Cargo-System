...
if(isset($btn))
{
$qry = "update cargo_details set fweight='$fweight', fpetrol='$fpetrol' where idno='$idno'";
echo "update cargo_details set fweight='$fweight', fpetrol='$fpetrol' where idno='$idno'";
...
<script>
setTimeout(function () {
window.location.href='upcargo.php';
}, 5000);
</script>
<?php
}
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col form-group">
                      <input name="fweight" type="text" class="form-control" placeholder="Final Weight" required>
                    </div>
                  ...
                  <div class="row">
                    <div class="col form-group">
                      <input name="fpetrol" type="text" class="form-control" placeholder="Petrol Consuption" required>
                    </div>
