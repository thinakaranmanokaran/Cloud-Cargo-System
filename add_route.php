...
if(isset($btn))
{
$mq=mysqli_query($connect,"select max(id) from cargotruck_route");
$mr=mysqli_fetch_array($mq);
$id=$mr['max(id)']+1;

mysqli_query($connect,"insert into cargotruck_route(id,truckno,route,lat,lon) values($id,'$truckno','$route','$lat','$lon')");
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <div class="sidebar">
              ...
              <h3 class="sidebar-title">Add Lorry Route</h3>
              <div class="reply-form">
                <form name="form1" method="post" action="">
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input name="route" type="text" class="form-control" placeholder="Location" required>
                    </div>
