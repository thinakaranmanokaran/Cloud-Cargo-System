...
extract($_REQUEST);
	if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from cargo_driver where uname='$uname' && pass='$pass' ");
			$n1=mysqli_num_rows($q1);
				if($n1==1)
				{
				$_SESSION['driver']=$uname;
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="login_driver.php">Driver</a></li>
                ...
                <form name="form1" method="post" action="">
                  <div class="row">
                    <div class="col form-group">
                      <input name="uname" type="text" class="form-control" placeholder="Driver ID" required>
                    </div>
