...
if($act=="del")
{
mysqli_query($connect,"delete from customer where id=$did");
?>
...
<body>
  ...
  <main id="main">
   ...
   <section id="services" class="services">
	...
	<?php
	$cq=mysqli_query($connect,"select * from  customer");
	while($cr=mysqli_fetch_array($cq))
	{
	?>
	<option <?php if($username==$cr['username']) echo "seleted"; ?>><?php echo $cr['username']; ?></option>
    <?php
	}
	?>
	</select>
	...
	<input type="submit" name="b1" value="Go" class="btn">
		...
		<?php
		$q1=mysqli_query($connect,"select * from customer");
		...
		?>
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4>Name:-<a href=""><?php echo $r1['name']; ?></a></h4>
              <p>Mobile No.: <?php echo $r1['mobile']; ?></p>
			  <p>City: <?php echo $r1['city']; ?></p>
			  <p>registered Date: <?php echo $r1['rdate']; ?></p>
			 
			  <p align="right"><a href="view_staff.php?act=del&did=<?php echo $r1['id']; ?>&username=<?php echo $username; ?>">Delete</a></p>
            </div>
          </div>
		 <?php
		 	}
